...
export interface IFileInfoResponse extends ISlackResponse {
  readonly file?: {
    readonly id: string;
...
export interface IAddFileCommentResponse extends ISlackResponse {
  readonly comment?: {
    readonly id: string;
    readonly created: number;
    readonly timestamp: number;
...
export interface IChannelInfoResponse extends ISlackResponse {
  readonly channels?: IChannelInfo[];
}
...
export interface IFileCreatedEvent {
  type: string;
  file: {
    id: string;
  };
